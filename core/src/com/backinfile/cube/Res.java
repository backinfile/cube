...
public class Res {
    ...
    public static TextureRegionDrawable BUTTON_UP;
    public static TextureRegionDrawable BUTTON_DOWN;
    public static TextureRegionDrawable BUTTON_LEFT;
    public static TextureRegionDrawable BUTTON_RIGHT;
    public static TextureRegionDrawable BUTTON_CANCEL;
    public static TextureRegionDrawable BUTTON_EXIT;
    public static TextureRegionDrawable BUTTON_RESTART;
    ...
    private static TextureRegionDrawable getInternalTexture(String path) {
