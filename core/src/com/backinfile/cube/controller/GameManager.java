...
import com.backinfile.cube.support.*;
...
public class GameManager {
    ...
    public void limitMoveForAWhile() {
        limitMoveTimer = Time2.getCurMillis() + (long) (GameViewManager.ANI_DURATION * Time2.SEC);
    }

    public void limitMoveForSecond() {
        limitMoveTimer = Time2.getCurMillis() + Time2.SEC;
    }

    public boolean isLimitMove() {
        return Time2.getCurMillis() < limitMoveTimer;
    }
